...
public class FarmerProfileEntity {
  ...
  @Column(nullable = false)
  private FarmerProfileStatus status;
  ...
  public FarmerProfileStatus getStatus() {
    return status;
  }
  ...
  public void updateStatus(FarmerProfileStatus status, Instant now) {
    this.status = status;
    this.updatedAt = now;
  }
}
